...
(function(e, t) {
    ...
    function T(e, t) {
        ...
        for (var n = t.charAt(0)
                .toUpperCase() + t.slice(1), r = t, i = Nn.length; i--;)
    ...
    function B(e, t) {
        st.each(t, function(t, n) {
            for (var r = (rr[t] || [])
                    .concat(rr["*"]), i = 0, o = r.length; o > i; i++)
    ...
    st.Callbacks = function(e) {
        ...
        when: function(e) {
            ...
            if (a > 1)
                for (t = Array(a), n = Array(a), r = Array(a); a > i; i++) o[i] && st.isFunction(o[i].promise) ? o[i].promise()
                    .done(l(i, r, o))
                    .fail(u.reject)
                    .progress(l(i, n, t)) : --s;
    ...
    st.event = {
            ...
            remove: function(e, t, n, r, i) {
                ...
                if (m && (u = m.events)) {
                    for (t = (t || "")
                        .match(lt) || [""], l = t.length; l--;)
                        if (s = Bt.exec(t[l]) || [], d = g = s[1], h = (s[2] || "")
                            .split(".")
                            .sort(), d) {
